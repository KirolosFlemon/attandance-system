...
<div id="wrapper" class="d-flex align-items-stretch flex-column">
    ...
    if (isset($_GET['delete']) &&!empty($_GET['delete'])) {
        ...
        $stmt_update = mysqli_query($website, "DELETE FROM gallery WHERE gallery_id= '$news' ") or die(mysqli_error($website));
        echo "<script type='text/javascript'> setTimeout(function() {window.location.href = '".$server."admin/application/gallery/'}, 1000)</script>";
        ...
        <div id="middle" class="flex-fill">
            ...
            <div class="page-title shadow-xs">
                ...
                <h1 class="h2 mt--10 mb--10  font-weight-normal">
                    ...
                    <div class="col-6 text-align-end">
                        <a class="d btn btn-outline-primary btn-pill m--10" href="<?php echo $server?>admin/application/gallery/?add">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($avatarname) && !in_array($avatarextension, $avatarallowedextension)) {
                    ...
                    move_uploaded_file($avatartmp, "../../../uploads/admin/gallery/" . $avatar);
                ...
                if (isset($_POST['gallery_id']) && !empty($_POST['gallery_id'])) {
                    ...
                    mysqli_select_db($website, $database_website);
                    $stmt = mysqli_query($website, "UPDATE gallery set
                     gallery_title = '$gallery_title' ,  
                      company_id = '$company_id' ,
                      gallery_photo= '$avatar'
                      WHERE gallery_id = '$id' ") or die(mysqli_error($website));

                } else {

                $stmt = mysqli_query($website, "INSERT INTO gallery ( gallery_title, gallery_photo ,company_id )
                                                          VALUES 
                                                          ('$gallery_title','$avatar', '$company_id' )") or die(mysqli_error($website));
                                ...
                                <div class="row gutters-sm d-flex align-items-center">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-label-group">
                                            <input required placeholder="Gallery Title" id="gallery_title" name="gallery_title" type="text" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-label-group ">
                                            <select id="select_options" required class="form-control bs-select" name="company_id" title="Choose Company">
                                                <?php
            ...
            mysqli_select_db($website, $database_website);
            $stmt_gallery = mysqli_query($website, "SELECT * FROM gallery WHERE gallery_id ='$id' ") or die(mysqli_error($website));
            $row_gallery = mysqli_fetch_assoc($stmt_gallery);
                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row gutters-sm d-flex align-items-center">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-label-group">
                                            <input required placeholder="Gallery Title" id="gallery_title" name="gallery_title" type="text" value="<?php echo $row_gallery['gallery_title']?>" class="form-control">
                                            <label for="gallery_title">Gallery Title</label>
                                        </div>

                                    </div>
                                    <input hidden value="<?php echo $row_gallery['gallery_id']; ?>" name="gallery_id">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-label-group ">
                                            <select id="select_options" class="form-control bs-select" name="company_id" title="Choose Company">
                                                ...
                                                do {
                                                    ?>
                                                    <option value="<?php echo $row_campany['company_id'] ?>" <?php echo ($row_campany['company_id']==$row_gallery['company_id'])?'selected':'';?>><?php echo $row_campany['company'] ?></option>
                                                    <?php
                                                }while ($row_campany= mysqli_fetch_assoc($stmt_campany));
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-12 col-md-12 mt--20">
                                        ...
                                        <div class="js-file-input-preview-single-container2  ml--n6 mr--n6 mt-4 hide-empty"><img src="../../../uploads/admin/gallery/<?php echo $row_gallery['gallery_photo']?>"width='100' height='100'  ><!-- preview container --></div>
                                    ...
                                    <div class="col-12 col-md-12 mt--20" hidden="hidden">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file custom-file-primary">
                                                ...
                                                -->
                                                <input 	name="avatar1"
                                                          type="text" value="<?php echo $row_gallery['gallery_photo']?>">
                                        ...
                                        <div class="js-file-input-preview-single-container2  ml--n6 mr--n6 mt-4 hide-empty"><img src="../../../uploads/admin/galley/<?php echo $row_gallery['gallery_photo']?>"width='100' height='100'  ><!-- preview container --></div>
                                ...
                                <div class="container py-2">
                                    ...
                                    >
                                        ...
                                        $stmt = mysqli_query($website,
                                            ...
                                            "SELECT * FROM gallery INNER JOIN  product_company
                                            ON  gallery.company_id = product_company.company_id ")
                                        or die(mysqli_error($website));

                                        $row_gallery1 = mysqli_fetch_assoc($stmt);
                                        ?>
                                        <thead>
                                        <tr>
                                            <th>Photo</th>
                                        ...
                                        <tbody>
                                        <?php
                                        if (!empty($row_gallery1)){
                                        do{
                                        ?>

                                        <tr>
                                            <td><img src='<?php echo $server ?>uploads/admin/gallery/<?php echo $row_gallery1['gallery_photo']?>' width='50' height='50' ></td>
                                            <td><?php echo $row_gallery1['gallery_title']; ?></td>
                                            <td><?php echo $row_gallery1['company']; ?></td>
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-clean dropdown-click-ignore max-w-220">
                                                            ...
                                                            <div class="scrollable-vertical max-h-50vh">
                                                                ...
                                                                <a class="dropdown-item text-truncate" href="<?php echo $server?>admin/application/gallery/?edit&gallery_id=<?php echo $row_gallery1['gallery_id'] ?>">
                                                                ...
                                                                <a
                                                                        ...
                                                                        data-href="?delete=<?php echo $row_gallery1['gallery_id'] ?>"
                                            ...
                                            <?php
                                        } while ($row_gallery1 = mysqli_fetch_assoc($stmt));
                                        }
                                        ?>
