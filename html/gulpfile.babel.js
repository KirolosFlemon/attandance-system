...
Smarty.gulp.task('html:build_frontend', (cb) => {

	var html_dest = Smarty.helper.argv(4);

	if(!html_dest) {

		Smarty.helper.log('light', '-------------------------------------------------', 'mb-0');
		Smarty.helper.log('light', 'HTML files built to ./dist/ folder', 'mb-0');
		Smarty.helper.log('light', 'Notice: you can also set a different destination for compiled html:', 'mb-0');
		Smarty.helper.log('light', 'gulp html:build_frontend --dest another_dir', 'mt-0');
		Smarty.helper.log('light', '-------------------------------------------------', 'mt-0');

		var html_dest = Smarty.settings.gulp_plugins.build_html.html_files.dest_frontend;
	}

	/* -- -- -- -- -- -- -- -- -- -- */
	Smarty.html.build_frontend(html_dest);
	/* -- -- -- -- -- -- -- -- -- -- */
...
Smarty.gulp.task('html:build_admin', (cb) => {
	...
	if(!html_dest) {
		...
		Smarty.helper.log('light', 'HTML files built to ./dist/ folder', 'mb-0');
		Smarty.helper.log('light', 'Notice: you can also set a different destination for compiled html:', 'mb-0');
		Smarty.helper.log('light', 'gulp html:build_admin --dest another_dir', 'mt-0');
		Smarty.helper.log('light', '-------------------------------------------------', 'mt-0');
		
		var html_dest = Smarty.settings.gulp_plugins.build_html.html_files.dest_admin;
	}

	/* -- -- -- -- -- -- -- -- -- -- */
	Smarty.html.build_admin(html_dest);
	/* -- -- -- -- -- -- -- -- -- -- */
...
Smarty.gulp.task(':help', (cb) => {
	...
	Smarty.helper.log('light', '-----------', 'm-0');
	Smarty.helper.log('light', 'gulp html:build_frontend --dest my_project 	= build html from source, according to gulp.config.settings.js', 'm-0');
	Smarty.helper.log('light', 'gulp html:build_admin --dest my_project 	= build html from source, according to gulp.config.settings.js', 'm-0');
	Smarty.helper.log('light', '-----------', 'm-0');
