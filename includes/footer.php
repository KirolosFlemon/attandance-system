                ...
                <li class="dropdown list-inline-item m-0">
                    ...
                    <a id="topDDLanguage" href="#!" class="d-inline-block" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                        ...
                        <?php }else{?>
                            ...
                            <span class="text-muted pl-2 pr-2">ARABIC</span>
                            <?php
                        }
                        ?>
                    </a>
                    ...
                    <div aria-labelledby="topDDLanguage" class="dropdown-menu fs--13 px-1 pt-1 pb-0 m-0 max-h-50vh scrollable-vertical dropdown-menu-right">
                        <a href="<?php echo $english_link?>" class="active dropdown-item text-muted text-truncate line-height-1 rounded p--12 mb-1">
                            <i class="flag flag-us"></i>
                            ENGLISH
                        </a>
                        <a href="<?php echo $arabic_link ?>" class="dropdown-item text-muted text-truncate line-height-1 rounded p--12 mb-1">
                            <i class="flag flag-eg"></i>
                            ARABIC
                        </a>
